...
El notebook anterior fue el primer entorno para aprender el patrón: SQLite + FastMCP + tools SQL + agente LangChain + OpenAI. Esta versión conserva el stack, pero formaliza responsabilidades y reemplaza los datos simulados por un dataset real de e-commerce.
